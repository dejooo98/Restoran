...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Opis jela</span></h2>
			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc">Kategorija:</span> <?php echo $cat; ?></p>
						<p><span class="bold_desc price">Cjena:</span> #<span id="price"><?php echo $price; ?></span></p>
						<div class="form_group">
							
							<p><span class="bold_desc">Kolicina:</span></p>
						...
						<p><span class="bold_desc">Ukupna cjena:</span> #<span id="total_price"><?php echo $price; ?></span></p>
						
						<div class="form_group">
							<input type="hidden" name="fid" value="<?php echo $id; ?>">
							<input type="submit" name="submit" class="submit add_order" value="Dodajte u korpu" />
						</div>					
					</form>					
				</div>			
				<p class="clear"></p>				
