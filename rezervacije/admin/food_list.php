<?php 
	...
	$per_page = 20;
		...
		if($cat->num_rows) {
			...
			$result = "<p style='color:red; padding: 10px; background: #ffeeee;'>Nema podataka u bazi</p>";
	...
	if(isset($_GET['delete'])) {
		...
		if($delete != "") {
			...
			if($sql) {
				...
				echo "<script>alert('Uspjesno obrisano')</script>";
				
			}else{
				
				echo "<script>alert('Operacija nije uspjela. Molimo pokusajte ponovo')</script>";
...
<head>
	...
	<script>
		...
		function check() {
			...
			return confirm("Da li ste sigurni da zelite da obrisete ovo jelo!");
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">LISTA PORUDZBINA</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; 2020 <a href="index.php" style="color: #FF5722;">Restoran MaDdoxX</a>
                </p>
            </div>
        </footer>
