	...
	if(isset($_GET['delete'])) {
		...
		if($delete != "") {
			...
			if($sql) {
				...
				echo "<script>alert('Operacija nije uspjela! Pokusajte ponovo!')</script>";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">REZERVACIJE</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Lista REZERVACIJA</h4>
                            </div>
