        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">DODAJTE NOVO JELO</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">FORMA ZA DODAVANJE JELA</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="food_add.php" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label style="color: #333">KATEGORIJA</label>
                                                <select name="category" class="form-control" required />
													<option value="">Izaberite kategoriju jela</option>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333">Naziv jela</label>
                                                <input type="text" autofocus name="name" class="form-control" placeholder="Unesite naziv jela" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333" for="price">Cjena</label>
                                                <input type="text" name="price" id="price" class="form-control" placeholder="Unesite cjenu" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333" for="txtarea">Opis</label>
                                                <textarea id="txtarea" class="form-control" placeholder="Unesite opis jela" name="desc" required></textarea>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label style="display: block; border-radius: 5px; letter-spacing: 2px; background: #fff; color: #333; padding: 10px; border: 1px solid #ccc; cursor: pointer; text-align: center; font-size: 15px; font-weight: bold;" for="file" class="file_lbl"><i style="font-weight: bold; font-size: 19px;" class="pe-7s-upload"></i>Izaberite fotografiju<input type="file"  style="display: none;" id="file" name="file" required /></label>
                                            </div>
                                        </div>
										
									</div>
									
                                    <input type="submit" name="submit" style="background: #FF5722; border: 1px solid #FF5722" value="Dodaj jelo" class="btn btn-info btn-fill pull-right" />
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <?php echo strftime("%Y", time())?> <a href="index.php">Restoran MaDdoxX</a>
                </p>
            </div>
        </footer>
