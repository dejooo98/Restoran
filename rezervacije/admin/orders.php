						...
						$items .= "<tr>
									...
									<td>
										<select onChange=\"change_stat('".$oid."')\" name='status' id='".$oid."' class='form-control'>
											<option value='pending_$oid' selected>U pripemi</option>
											<option value='confirmed_$oid'>Spremno</option>
										</select>
									</td>
									<th></th>
								</tr>";
		...
		if(isset($_GET['delete']) && escape($_GET['delete']) != "") {
			...
			if($bird_id != "") {
				...
				if($query->execute()) {
					...
					echo "<script>alert('Uspjesno ste obrisali!')</script>";
					
				}else{
					
					echo "<script>alert('Nije moguce obrisati!')</script>";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #FF5722;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">KORPA ZA NARUCIVANJE</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="text-align: center">PORUDZBINE</h4>
                            </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; 2016 <a href="index.php" style="color: #FF5722;">Restoran MaDdoxX</a>
                </p>
            </div>
        </footer>
